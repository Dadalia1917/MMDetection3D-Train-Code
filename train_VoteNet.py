...
def get_config_file(dataset):
    ...
    config_map = {
        'scannet': 'configs/votenet/votenet_8xb16_scannet-3d.py',
        'sunrgbd': 'configs/votenet/votenet_8xb8_sunrgbd-3d.py'
    }
    return config_map.get(dataset, config_map['scannet'])
...
def main():
    ...
    if args.work_dir is not None:
        ...
        if hasattr(args, 'dataset') and args.dataset:
            model_name = f'VoteNet_{args.dataset}'
