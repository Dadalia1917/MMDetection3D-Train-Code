...
def ensure_pointpillars_models():
    """确保PointPillars所需的预训练模型已下载"""
    models_dir = Path('./models/pointpillars')
    models_dir.mkdir(parents=True, exist_ok=True)
    
    # PointPillars KITTI 3类预训练权重
    pp_3class_url = 'https://download.openmmlab.com/mmdetection3d/v1.0.0_models/pointpillars/hv_pointpillars_secfpn_6x8_160e_kitti-3d-3class/hv_pointpillars_secfpn_6x8_160e_kitti-3d-3class_20220301_150306-37dc2420.pth'
    pp_3class_path = models_dir / 'hv_pointpillars_secfpn_6x8_160e_kitti-3d-3class_20220301_150306-37dc2420.pth'
    
    # PointPillars KITTI Car预训练权重
    pp_car_url = 'https://download.openmmlab.com/mmdetection3d/v1.0.0_models/pointpillars/hv_pointpillars_secfpn_6x8_160e_kitti-3d-car/hv_pointpillars_secfpn_6x8_160e_kitti-3d-car_20220331_134606-d42d15ed.pth'
    pp_car_path = models_dir / 'hv_pointpillars_secfpn_6x8_160e_kitti-3d-car_20220331_134606-d42d15ed.pth'
    
    print_log("Checking PointPillars model dependencies...", logger='current')
    
    # 可选：下载预训练权重（用于推理）
    pp_3class_result = download_file(pp_3class_url, pp_3class_path)
    pp_car_result = download_file(pp_car_url, pp_car_path)
    
    return pp_3class_result, pp_car_result


def get_config_file(dataset):
    """根据数据集选择配置文件"""
    config_map = {
        'kitti-3class': 'configs/pointpillars/pointpillars_hv_secfpn_8xb6-160e_kitti-3d-3class.py',
        'kitti-car': 'configs/pointpillars/pointpillars_hv_secfpn_8xb6-160e_kitti-3d-car.py',
        'nuscenes': 'configs/pointpillars/pointpillars_hv_fpn_sbn-all_8xb4-2x_nus-3d.py',
        'lyft': 'configs/pointpillars/pointpillars_hv_fpn_sbn-all_8xb4-2x_lyft-3d.py',
        'waymo': 'configs/pointpillars/pointpillars_hv_secfpn_sbn-all_16xb2-2x_waymoD5-3d-3class.py'
    }
...
def main():
    ...
    pp_3class_path, pp_car_path = ensure_pointpillars_models()
    ...
    if args.work_dir is not None:
        ...
        if hasattr(args, 'dataset') and args.dataset:
            model_name = f'PointPillars_{args.dataset}'
