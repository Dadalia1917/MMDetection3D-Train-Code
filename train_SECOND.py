...
def ensure_second_models():
    """确保SECOND所需的预训练模型已下载"""
    models_dir = Path('./models/second')
    models_dir.mkdir(parents=True, exist_ok=True)
    
    # SECOND KITTI 3类预训练权重
    second_3class_url = 'https://download.openmmlab.com/mmdetection3d/v1.0.0_models/second/hv_second_secfpn_6x8_80e_kitti-3d-3class/hv_second_secfpn_6x8_80e_kitti-3d-3class_20220301_144052-b6b46e36.pth'
    second_3class_path = models_dir / 'hv_second_secfpn_6x8_80e_kitti-3d-3class_20220301_144052-b6b46e36.pth'
    
    # SECOND KITTI Car预训练权重
    second_car_url = 'https://download.openmmlab.com/mmdetection3d/v1.0.0_models/second/hv_second_secfpn_6x8_80e_kitti-3d-car/hv_second_secfpn_6x8_80e_kitti-3d-car_20220301_144132-c7a20e05.pth'
    second_car_path = models_dir / 'hv_second_secfpn_6x8_80e_kitti-3d-car_20220301_144132-c7a20e05.pth'
    
    print_log("Checking SECOND model dependencies...", logger='current')
    
    # 可选：下载预训练权重（用于推理）
    second_3class_result = download_file(second_3class_url, second_3class_path)
    second_car_result = download_file(second_car_url, second_car_path)
    
    return second_3class_result, second_car_result
...
def main():
    ...
    second_3class_path, second_car_path = ensure_second_models()
    ...
    if args.work_dir is not None:
        ...
        if hasattr(args, 'dataset') and args.dataset:
            model_name = f'SECOND_{args.dataset}'
